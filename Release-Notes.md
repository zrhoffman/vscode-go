...
* [Kegsay @Kegsay](https://github.com/Kegsay)
    * Fix bug where debug codelens would run all tests that match the current test name. [PR 1561](https://github.com/Microsoft/vscode-go/pull/1561)
...
* [Nuruddin Ashr (@uudashr)](https://github.com/uudashr)
    * Do not allow internal packages to be imported. [PR 1535](https://github.com/Microsoft/vscode-go/pull/1535)

* [Ramya Rao (@ramya-rao-a)](https://github.com/ramya-rao-a)
    * Make links in test output clickable when it fails due to build errors. [Bug 1562](https://github.com/Microsoft/vscode-go/issues/1562)
...
* [Ramya Rao (@ramya-rao-a)](https://github.com/ramya-rao-a)
    ...
    * Fix for [Bug 1022](https://github.com/Microsoft/vscode-go/issues/1022) where snippets from function auto complete do not insert the placeholders
